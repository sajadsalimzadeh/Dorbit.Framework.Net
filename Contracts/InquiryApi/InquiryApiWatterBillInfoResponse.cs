...
public class InquiryApiWatterBillInfoResponse
{
    ...
    public InquiryApiWatterBillInfoResponseInfo Info { get; set; }
}

public class InquiryApiWatterBillInfoResponseInfo
{
