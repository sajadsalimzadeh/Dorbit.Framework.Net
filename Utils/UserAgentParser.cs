...
public sealed class UserAgentParser
{
    ...
    /// </summary>
    private static UserAgentParser _default;
    ...
    private UserAgentParser(MinimalYamlParser yamlParser, ParserOptions options)
    {
    ...
    public static UserAgentParser FromYaml(string yaml, ParserOptions parserOptions = null)
    {
        return new UserAgentParser(new MinimalYamlParser(yaml), parserOptions);
    }
    ...
    /// <param name="parserOptions">specifies the options for the parser</param>
    /// <returns></returns>
    public static UserAgentParser GetDefault(ParserOptions parserOptions = null)
    {
        if (_default is null)
        {
            using var stream = new FileStream(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Assets", "user-agent-regexes.yaml"), FileMode.Open);
            using var reader = new StreamReader(stream);
            _default = new UserAgentParser(new MinimalYamlParser(reader.ReadToEnd()), parserOptions);
        }
