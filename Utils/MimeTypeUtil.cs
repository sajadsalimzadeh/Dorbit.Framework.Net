...
public class MimeTypeUtil
{
    ...
    {
        return GetMimeTypeByExtension(Path.GetExtension(filename));
    }

    public static string GetMimeTypeByExtension(string extension)
    {
        return _mimeTypes.GetValueOrDefault(extension.ToLower());
    }

    public static string GetExtension(string mimeType)
    {
        return _mimeTypes.GetValueOrDefault(mimeType);
    }
}